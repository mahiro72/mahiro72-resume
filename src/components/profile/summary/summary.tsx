        ...
        <div className="mb-4 md:mb-8">
            ...
            <div className="font-light ml-8">
                ...
                <p className="mb-3">
                    ...
                    副業ではIT系のスタートアップを共同創業し、0から1のフェーズでの開発や、<br />
                    業務委託を通じて1から10の成長フェーズにあるスタートアップのバックエンド開発もしています。<br /><br />
                </p>
                <p className="mb-3">
                    最近の関心事は、コンピュータサイエンス、スタートアップ、<br />
                    ...
                    長々と描きましたが、とりあえずエンジニアリングに関わることであれば、何でも好きです。(適当)<br />
                </p>
            </div>
        </div>
    )
