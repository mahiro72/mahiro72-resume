    ...
    return (
        <div className="mb-4 md:mb-8">
            ...
            <div className="font-light ml-8">
                ...
                <p className="mb-3">
                    メガベンチャーに入社した新卒1年目のエンジニアです。<br />
                    Golangで基盤のAPIを開発したり、大規模なリプレイスなどを行っております。 <br />
                    また副業ではIT系の会社を共同創業しており会社自身も含めた0→1の開発や <br />
                    他にも業務委託で1→10フェーズのスタートアップにてバックエンドの開発なども行っております。<br /><br />

                    最近はコンピュータサイエンスやスタートアップ、<br />
                    アーキテクチャ(コードレベルからアプリケーションレベルの話まで)の話にが好きです。。<br />
                </p>
                <p className="mb-3">
