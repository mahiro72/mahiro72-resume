    ...
    return (
        <div className="mb-4 md:mb-8">
            ...
            <div className="font-light ml-8">
                ...
                <p className="mb-3">
                    普段はメガベンチャーにて、Golangを用いたマイクロサービスの基盤の設計•開発•運用をしています。またアーキテクトチームも兼務しており、マイクロサービスを横断した設計のお手伝いをしています。
                </p>
                <p className="mb-3">
                    副業では、AIスタートアップ複数社にて技術顧問を担当しており、サービスの設計からコードのレビュー、PMや組織設計など幅広く携わっています。他にもSREとしてSaaSのインフラ基盤構築や生成AIサービスの開発なども行っており、上流から下流まで幅広い領域で実務経験を積んでいます。
                </p>
                <br/>
                <p className="mb-3">
