...
import img_example from "../../../img/profile/work/company_example.png"
...
const data = {
    "work":[
        ...
        },
        {
            ...
            "img":img_starup,
            "name":"株式会社 STAR UP",
            "about":"業務委託 / 生成AIサービスの技術設計のレビューに取り組んでいます。"
        },
        {
            "date":"2024/8 - 現在",
            "img":img_upcare,
            "name":"株式会社 SPARQ",
            "about":"業務委託 / SREとしてインフラ基盤の構築や、アプリケーションの監視基盤を作っています。"
        },
        {
            "date":"2023/10 - 現在",
            "img":img_aivolt,
            "name":"株式会社AI VOLT",
            "about":"業務委託 / Python,FastAPIを利用し、LLMのサービスのバックエンドを開発運用しています。LLMをサービスに上手く組み込むためのアーキテクティングにも取り組んでいます。"
        },
        {
            "date":"2023/5 - 2024/2",
            "img":img_copalette,
        ...
        },
        {
            ...
            "img":img_ispec,
            "name":"株式会社ispec",
            "about":"業務委託 / Golangを用いたAPI開発をしました。"
        },
        {
            "date":"2023/3",
            "img":img_kw,
            "name":"株式会社ナレッジワーク",
            "about":"インターンシップ(3日) / Golangで「アーキテクチャの依存関係がルール違反してないか確認する静的解析ツール」を作成しました。"
        },
        {
            "date":"2022/8 - 2023/3",
            "img":img_plaid,
            "name":"株式会社プレイド",
            "about":"インターンシップ(8ヶ月) / Messageチームにて、API開発やSREの業務に取り組みました。"
        },
        {
            "date":"2022/9",
            "img":img_sansan,
            "name":"Sansan株式会社",
            "about":"インターンシップ(2週間) / ハッカソン"
        },
        {
            "date":"2022/4 - 2022/5",
            "img":img_gmo,
            "name":"GMOインターネット",
            "about":"DevSecOpsThon(3日) / 物理サーバーの構築やチューニングなどに取り組みました。"
        },
        {
            "date":"2021/4 - 2022/7",
            "img":img_sou,
            "name":"株式会社ソウ",
            "about":"業務委託 / フルスタックエンジニアとして、さまざまなシステム設計, 開発に取り組みました。"
        },
        {
            "date":"2022/3",
            "img":img_teamlab,
            "name":"チームラボ株式会社",
            "about":"インターンシップ(2週間) / フロントエンジニアとして、システム設計やテスト作成などの経験をしました。"
        },
        {
            "date":"2021/9",
            "img":img_cookpad,
            "name":"クックパッド株式会社",
            "about":"インターンシップ(1日) / RubyやGraphQLを用いた課題に取り組みました。"
        },
    ]
}
